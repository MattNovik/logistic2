...
/* harmony import */ var _modules_init_slider_photos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-slider-photos */ "./js/modules/init-slider-photos.js");
/* harmony import */ var _modules_init_form_validate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-form-validate */ "./js/modules/init-form-validate.js");
/* harmony import */ var _modules_init_move_to__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-move-to */ "./js/modules/init-move-to.js");
/* harmony import */ var _modules_init_menu_open__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-menu-open */ "./js/modules/init-menu-open.js");
/* harmony import */ var _modules_init_services_info__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-services-info */ "./js/modules/init-services-info.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_slider_photos__WEBPACK_IMPORTED_MODULE_2__["initPhotosSlider"])();
  Object(_modules_init_menu_open__WEBPACK_IMPORTED_MODULE_5__["initOpenMenu"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_form_validate__WEBPACK_IMPORTED_MODULE_3__["initFormValidate"])();
    Object(_modules_init_move_to__WEBPACK_IMPORTED_MODULE_4__["initMoveTo"])();
    Object(_modules_init_services_info__WEBPACK_IMPORTED_MODULE_6__["initServicesInfo"])();
  });
}); // ---------------------------------
...
/* harmony import */ var _form_validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validate */ "./js/modules/form-validate.js");
...
var menuOpener = document.querySelector('.main-nav__toggle');
var menuCloser = document.querySelector('.main-nav__close');
var menuOverlay = document.querySelector('.main-nav__overlay');
var menuWrapper = document.querySelector('.main-nav__wrapper-mob');
...
var initOpenMenu = function initOpenMenu() {
  ...
  menuCloser.addEventListener('click', function (evt) {
    evt.preventDefault();
    scrollLock.enableScrolling();
    menuWrapper.classList.remove('main-nav__wrapper--open');
    menuOverlay.classList.remove('main-nav__overlay--open');
...
/***/ "./js/modules/init-services-info.js":
/*!******************************************!*\
  !*** ./js/modules/init-services-info.js ***!
  \******************************************/
/*! exports provided: initServicesInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initServicesInfo", function() { return initServicesInfo; });
var servicesItems = document.querySelectorAll('.modules-types__item');
var breakpointMob = window.matchMedia('(max-width:959px)');

var servicesInfo = function servicesInfo() {
  servicesItems.forEach(function (item) {
    var itemInfo = item.querySelector('.modules-types__item-info');
...
var initServicesInfo = function initServicesInfo() {
...
/***/ "./js/modules/init-slider-photos.js":
/*!******************************************!*\
  !*** ./js/modules/init-slider-photos.js ***!
  \******************************************/
...
var photosSlider = document.querySelector('.slider-container');
